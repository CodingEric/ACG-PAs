...
void Application::OnUpdate() {
  ...
  ubo.model = Translate(glm::vec3{1.0f, 2.0f, 3.0f}) * model;
  ubo.view = LookAt(glm::vec3(0.0f, 0.0f, 5.0f), glm::vec3(1.0f, 2.0f, 3.0f),
                    glm::vec3(0.0f, 1.0f, 0.0f));
  ubo.proj =
      Perspective(glm::radians(45.0f),
  ...
  // frame
  model = model * Rotate(glm::normalize(glm::vec3(1.0f, 1.0f, 1.0f)),
